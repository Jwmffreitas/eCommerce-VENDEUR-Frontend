...
function verificarSenha () {
    if(document.getElementById('senha').value == "") {
        document.getElementById('senha').style.width = "300px"
    }else {
        document.getElementById('senha').style.width = "300px"
    }
}
...
function confirmarSenha () {
    if(document.getElementById('csenha').value == "") {
        document.getElementById('csenha').style.width = "300px"
    }else {
        document.getElementById('csenha').style.width = "300px"
...
function verificarWhats () {
    if(document.getElementById('number').value == "") {
        document.getElementById('number').style.width = "180px"
    }else {
        document.getElementById('number').style.width = "180px"
...
function verificarCEP () {
    if(document.getElementById('cep').value == "") {
        document.getElementById('cep').style.width = "180px"
    }else {
        document.getElementById('cep').style.width = "180px"
...
function verificarEndereco () {
    if(document.getElementById('ender').value == "") {
        document.getElementById('ender').style.width = "300px"
    }else {
        document.getElementById('ender').style.width = "300px"
    }
}
